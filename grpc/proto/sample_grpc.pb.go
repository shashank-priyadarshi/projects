...
type GreetServiceClient interface {
	SayHello(ctx context.Context, in *NoParams, opts ...grpc.CallOption) (*ResponseMessage, error)
}
...
func (c *greetServiceClient) SayHello(ctx context.Context, in *NoParams, opts ...grpc.CallOption) (*ResponseMessage, error) {
...
type GreetServiceServer interface {
	SayHello(context.Context, *NoParams) (*ResponseMessage, error)
...
func (UnimplementedGreetServiceServer) SayHello(context.Context, *NoParams) (*ResponseMessage, error) {
